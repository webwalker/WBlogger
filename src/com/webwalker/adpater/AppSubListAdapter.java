 ...
 * 
 */
public class AppSubListAdapter extends BaseAdapter {
	Context context;
	LayoutInflater inflater;
	View[] itemViews;
	ArrayList<String> mappingList;

	public AppSubListAdapter(Context context,
			ArrayList<UserAccountEntity> list, ArrayList<String> mapping) {
	...
	private boolean hasMapping(String uid) {
		return mappingList.contains(uid);
	}
