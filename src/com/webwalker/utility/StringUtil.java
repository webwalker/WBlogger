 ...
 * 
 * @author Frank.fan
 * @version $Id: TaxStringUtil.java, v 0.1 2011-5-5 下午01:43:01 fanmanrong Exp $
 */
public class StringUtil {
	...
	/**
	 * 获取字符串中，第一个中文字符之后的字符串。 中文类型的逗号，冒号，句号等，不算作中文字符。
	 * 
	 * @author wuhaoxiang
	 * @param str
	 *            要扫描的字符串
	 * @return 如果字符串中无中文，则返回空串
	 */
	...
	public static boolean isMobile(String str) {
		...
		final String reg = "^((13[0-9])|(15[^4,\\D])|(18[0-9]))\\d{8}$";
