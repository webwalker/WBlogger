...
public class StatusesAPI extends WeiboAPI {
	 ...
	 * @param listener
	 */
	public void userTimeline(String source, long uid, long since_id,
	 ...
	 * @param listener
	 */
	public void userTimelineIds(String source, long uid, long since_id,
			long max_id, int count, int page, boolean base_app,
	 ...
	 * @param listener
	 */
	public void userTimelineIds(String source, String screen_name,
			long since_id, long max_id, int count, int page, boolean base_app,
			FEATURE feature, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("source", source);
		params.add("screen_name", screen_name);
